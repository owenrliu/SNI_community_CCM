...
### 2. $\sc{Adding Physical Variables}$
...
```{r univariate simplex,fig.height=4,include=T}
# Run simplex projection for each species, and plot output. this is a really long thing to see if the pdf can handle it. the quick brown fox jumps over the lazy dog.
par(mfrow=c(1,1))
for(i in 1:2) {
  
  # Plot embedding dimension vs. predictive ability (rho)
  plot(rnorm(12),rnorm(12),type="l",main="TEST this is a really long thing to see if the pdf can handle it. the quick brown fox jumps over the lazy dog.")
}
```
