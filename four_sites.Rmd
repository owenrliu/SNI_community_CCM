...
plot(westend$red,westend$mac,pch=18,xlab="Red Urchin Density (normalized)",ylab="Macrocystis adult density (normalized)")
...
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$pter$coeffs$mac,ylim=c(-0.2,.05),ylab="",xlab="")
...
```{r dutch v west end}
dutch.means <- dutch %>% group_by(period) %>% summarise_each(funs(m=mean(.,na.rm=T),sd=sd(.,na.rm=T)),one_of(lib.vars))
westend.means <- westend %>% group_by(period) %>% summarise_each(funs(m=mean(.,na.rm=T),sd=sd(.,na.rm=T)),one_of(lib.vars))
ggplot(dutch.means,aes(x=period,y=mac_m)) +
  geom_line(size=1.5,col="darkgreen")+
  geom_pointrange(aes(ymin=mac_m-mac_sd,ymax=mac_m+mac_sd),col="darkgreen")+
  geom_line(aes(y=purp_m),size=1.5,col="mediumpurple4")+
  geom_pointrange(aes(y=purp_m,ymin=purp_m-purp_sd,ymax=purp_m+purp_sd),col="mediumpurple4")+
  scale_x_discrete(breaks=NULL)+
  theme_minimal()+
  xlab("time")+ylab("Normalized Density")

ggplot(westend.means,aes(x=period,y=mac_m)) +
  geom_line(size=1.5,col="darkgreen")+
  geom_pointrange(aes(ymin=mac_m-mac_sd,ymax=mac_m+mac_sd),col="darkgreen")+
...
Why and when does Purp sometimes have a positive effect on Mac at Dutch?

```{r purp mac dutch}

# modifiers of purp effect on mac
cor(dutch.multi.mods$mac$coeffs$purp,dutch[,3:13],use="complete.obs")
par(mfrow=c(2,2),mar=c(2,2,2,2)+0.1)
quant_reg_plot(dutch$mac,dutch.multi.mods$mac$coeffs$purp)
quant_reg_plot(dutch$lam,dutch.multi.mods$mac$coeffs$purp)
quant_reg_plot(dutch$purp,dutch.multi.mods$mac$coeffs$purp)
quant_reg_plot(dutch$waves.max,dutch.multi.mods$mac$coeffs$purp)

# modifiers of purp effect on pter
cor(dutch.multi.mods$pter$coeffs$purp,dutch[,3:13],use="complete.obs")
par(mfrow=c(2,2),mar=c(2,2,2,2)+0.1)
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$pter$coeffs$purp)
quant_reg_plot(dutch$purp,dutch.multi.mods$pter$coeffs$purp)
quant_reg_plot(dutch$mac,dutch.multi.mods$pter$coeffs$purp)
quant_reg_plot(dutch$waves.max,dutch.multi.mods$pter$coeffs$purp)

# modifiers of mac effect on pter
cor(dutch.multi.mods$pter$coeffs$mac,dutch[,3:13],use="complete.obs")
par(mfrow=c(2,2),mar=c(2,2,2,2)+0.1)
quant_reg_plot(dutch$lam,dutch.multi.mods$pter$coeffs$mac)
quant_reg_plot(dutch$mac,dutch.multi.mods$pter$coeffs$mac)
quant_reg_plot(dutch$ymac,dutch.multi.mods$pter$coeffs$mac)
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$pter$coeffs$mac)

# modifiers of pter effect on mac
cor(dutch.multi.mods$mac$coeffs$pter,dutch[,3:13],use="complete.obs")
par(mfrow=c(2,2),mar=c(2,2,2,2)+0.1)
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$mac$coeffs$pter)
quant_reg_plot(dutch$pter,dutch.multi.mods$mac$coeffs$pter)
quant_reg_plot(dutch$lam,dutch.multi.mods$mac$coeffs$pter)
quant_reg_plot(dutch$pdo.mean,dutch.multi.mods$mac$coeffs$pter)

# modifiers of purp effect on ymac
cor(dutch.multi.mods$ymac$coeffs$purp,dutch[,3:13],use="complete.obs")
par(mfrow=c(2,2),mar=c(2,2,2,2)+0.1)
quant_reg_plot(dutch$waves.max,dutch.multi.mods$ymac$coeffs$purp)
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$ymac$coeffs$purp)
quant_reg_plot(dutch$mei.mean,dutch.multi.mods$ymac$coeffs$pter)
quant_reg_plot(dutch$pdo.mean,dutch.multi.mods$ymac$coeffs$purp)
```

NPGO and Competitive Dominance

```{r npgo and dominance}
#NPGO and mac recruitment (ymac)
cor(dutch$npgo.mean,dutch.multi.mods$ymac$coeffs,use="complete.obs")
par(mfrow=c(2,2),mar=c(2,2,2,2)+0.1)
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$ymac$coeffs$ymac)
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$ymac$coeffs$mac)
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$ymac$coeffs$waves.max) #**##

cor(westend$npgo.mean,westend.multi.mods$ymac$coeffs[,1:11],use="complete.obs")
quant_reg_plot(westend$npgo.mean,westend.multi.mods$ymac$coeffs$ymac)
quant_reg_plot(westend$npgo.mean,westend.multi.mods$ymac$coeffs$purp) ##**##

#NPGO and mac
cor(dutch$npgo.mean,dutch.multi.mods$mac$coeffs,use="complete.obs")
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$mac$coeffs$ymac)
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$mac$coeffs$pter)
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$mac$coeffs$mac)

cor(westend$npgo.mean,westend.multi.mods$mac$coeffs[,1:11],use="complete.obs")
quant_reg_plot(westend$npgo.mean,westend.multi.mods$mac$coeffs$pter,xlab="",ylab="") ##*##
quant_reg_plot(westend$npgo.mean,westend.multi.mods$mac$coeffs$purp) ##*##
quant_reg_plot(westend$npgo.mean,westend.multi.mods$mac$coeffs$waves.max) ##*##
quant_reg_plot(westend$npgo.mean,westend.multi.mods$mac$coeffs$ymac)

#NPGO and pter
cor(dutch$npgo.mean,dutch.multi.mods$pter$coeffs,use="complete.obs")
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$pter$coeffs$purp) ##*##
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$pter$coeffs$lam) ##*##
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$pter$coeffs$ymac)
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$pter$coeffs$mac) ##*##

cor(westend$npgo.mean,westend.multi.mods$pter$coeffs[,1:9],use="complete.obs")
quant_reg_plot(westend$npgo.mean,westend.multi.mods$pter$coeffs$mac) ##*##
quant_reg_plot(westend$npgo.mean,westend.multi.mods$pter$coeffs$ymac)

#NPGO and lam
cor(westend$npgo.mean,westend.multi.mods$lam$coeffs[,1:8],use="complete.obs")
quant_reg_plot(westend$npgo.mean,westend.multi.mods$lam$coeffs$red)
quant_reg_plot(westend$npgo.mean,westend.multi.mods$lam$coeffs$purp)
...
```{r wave effects}
# Waves and young mac
cor(dutch$waves.max,dutch.multi.mods$ymac$coeffs,use="complete.obs")
par(mfrow=c(2,2),mar=c(2,2,2,2)+0.1)
quant_reg_plot(dutch$waves.max,dutch.multi.mods$ymac$coeffs$ymac) ##*##
quant_reg_plot(dutch$waves.max,dutch.multi.mods$ymac$coeffs$npgo.mean) ##*##
quant_reg_plot(dutch$waves.max,dutch.multi.mods$ymac$coeffs$pter) ##*##
quant_reg_plot(dutch$waves.max,dutch.multi.mods$ymac$coeffs$waves.max)

cor(westend$waves.max,westend.multi.mods$ymac$coeffs[,1:11],use="complete.obs")
quant_reg_plot(westend$waves.max,westend.multi.mods$ymac$coeffs$ymac)
quant_reg_plot(westend$waves.max,westend.multi.mods$ymac$coeffs$pter)

#Waves and mac
cor(dutch$waves.max,dutch.multi.mods$mac$coeffs,use="complete.obs")
quant_reg_plot(dutch$waves.max,dutch.multi.mods$mac$coeffs$purp) ##*##
quant_reg_plot(dutch$waves.max,dutch.multi.mods$mac$coeffs$ymac) ##*##
quant_reg_plot(dutch$waves.max,dutch.multi.mods$mac$coeffs$npgo.mean) ##*##
quant_reg_plot(dutch$waves.max,dutch.multi.mods$mac$coeffs$waves.max) ##?##
quant_reg_plot(dutch$waves.max,dutch.multi.mods$mac$coeffs$mac)

cor(westend$waves.max,westend.multi.mods$mac$coeffs[,1:11],use="complete.obs")
quant_reg_plot(westend$waves.max,westend.multi.mods$mac$coeffs$purp)
quant_reg_plot(westend$waves.max,westend.multi.mods$mac$coeffs$waves.max) ##?##

#Waves and pter
cor(dutch$waves.max,dutch.multi.mods$pter$coeffs,use="complete.obs")
quant_reg_plot(dutch$waves.max,dutch.multi.mods$pter$coeffs$purp)
quant_reg_plot(dutch$waves.max,dutch.multi.mods$pter$coeffs$lam)

cor(westend$waves.max,westend.multi.mods$pter$coeffs[,1:9],use="complete.obs")
quant_reg_plot(westend$waves.max,westend.multi.mods$pter$coeffs$purp)
quant_reg_plot(westend$waves.max,westend.multi.mods$pter$coeffs$npgo.mean)

#Waves and lam
cor(westend$waves.max,westend.multi.mods$lam$coeffs[,1:8],use="complete.obs")
quant_reg_plot(westend$waves.max,westend.multi.mods$lam$coeffs$purp) ##*##
quant_reg_plot(westend$waves.max,westend.multi.mods$lam$coeffs$pter,xlab="",ylab="") ##*##
```

What determines direction of West End effect of macrocystis on understory?
```{r west end mac understory}
cor(westend.multi.mods$lam$coeffs$mac,westend[,3:13],use="complete.obs")
quant_reg_plot(westend$purp,westend.multi.mods$lam$coeffs$mac)
quant_reg_plot(westend$npgo.mean,westend.multi.mods$lam$coeffs$mac)

cor(westend.multi.mods$pter$coeffs$mac,westend[,3:13],use="complete.obs")
quant_reg_plot(westend$pter,westend.multi.mods$pter$coeffs$mac)
quant_reg_plot(westend$npgo.mean,westend.multi.mods$pter$coeffs$mac,
               xlab="NPGO Index (normalized)",ylab="Interaction Strength",lvl=0.9,xlim=c(-2,1.5)) ##*##
```

What determines direction of West End effect of understory on young mac?
```{r west end understory ymac}
cor(westend.multi.mods$ymac$coeffs$lam,westend[,3:13],use="complete.obs")
quant_reg_plot(westend$npgo.mean,westend.multi.mods$ymac$coeffs$lam,xlab="",ylab="")##*##
quant_reg_plot(westend$purp,westend.multi.mods$ymac$coeffs$lam)

cor(westend.multi.mods$ymac$coeffs$pter,westend[,3:13],use="complete.obs")
quant_reg_plot(westend$purp,westend.multi.mods$ymac$coeffs$pter)
```

What determines direction of Dutch Harbor effect of urchins on macrocystis?
```{r dutch mac urchin mac}
cor(dutch.multi.mods$mac$coeffs$purp,dutch[,3:13],use="complete.obs")
quant_reg_plot(dutch$purp,dutch.multi.mods$mac$coeffs$purp) ##*##
quant_reg_plot(dutch$lam,dutch.multi.mods$mac$coeffs$purp) ##*##
quant_reg_plot(dutch$mac,dutch.multi.mods$mac$coeffs$purp) ##*##
quant_reg_plot(dutch$ymac,dutch.multi.mods$mac$coeffs$purp) 
quant_reg_plot(dutch$npgo.mean,dutch.multi.mods$mac$coeffs$purp)
quant_reg_plot(dutch$waves.max,dutch.multi.mods$mac$coeffs$purp)

summary(lm(dutch.multi.mods$mac$coeffs$purp~dutch$purp+dutch$lam+dutch$mac+dutch$ymac+dutch$npgo.mean+dutch$waves.max))

```

What determines direction of Dutch Harbor effect of waves on macrocystis?
```{r dutch waves mac}
cor(dutch.multi.mods$mac$coeffs$waves.max,dutch[,3:13],use="complete.obs")
quant_reg_plot(dutch$mac,dutch.multi.mods$mac$coeffs$waves.max) ##*##
quant_reg_plot(dutch$ymac,dutch.multi.mods$mac$coeffs$waves.max)
quant_reg_plot(dutch$waves.max,dutch.multi.mods$mac$coeffs$waves.max)
quant_reg_plot(dutch$sst.mean,dutch.multi.mods$mac$coeffs$waves.max)

```

What determines direction of Dutch Harbor effect of pterygophora on young macrocystis?
```{r dutch mac urchin mac}
cor(dutch.multi.mods$ymac$coeffs$pter,dutch[,3:13],use="complete.obs")
quant_reg_plot(dutch$purp,dutch.multi.mods$ymac$coeffs$pter)
quant_reg_plot(dutch$waves.max,dutch.multi.mods$ymac$coeffs$pter)
```
...
```{r effects over time}
westend.mac.effects <- westend.mean_ints$mac$mean_ints %>%
  filter(effect %in% c("purp","ymac","pter"))

par(mar=c(5, 4, 4, 2) + 0.1)
ggplot(westend.mac.effects, aes(color=effect,x=period,y=meanint,ymin=lowerint,ymax=upperint)) +
  geom_line(size=1.5) +
  geom_pointrange()+
  scale_color_manual(values=c("darkred","mediumpurple4","darkgreen"),labels=c("Pterygophora","Purple Urchin","Macrocystis recruits"),name="Interacting Species")+
  geom_hline(yintercept=0,linetype=2) +
  xlab("Monitoring Period")+ylab("Interaction Strength")+
  theme_minimal()+
  theme(legend.position=c(0.1,0.1))

```

## Interactive effects of waves and NPGO

```{r interactions}
quant_reg_plot(dutch.multi.mods$mac$coeffs$npgo.mean,dutch.multi.mods$mac$coeffs$waves.max,ylab="",xlab="") #**##
quant_reg_plot(westend.multi.mods$mac$coeffs$npgo.mean,westend.multi.mods$mac$coeffs$waves.max,ylab="",xlab="") #**##
```

## Histograms of Mac effect on Pter

```{r diffs over space}
mac_on_pter_dutch <- dutch.multi.mods$pter$coeffs %>% select(mac) %>% mutate(site="Dutch Harbor")
mac_on_pter <- westend.multi.mods$pter$coeffs %>% select(mac) %>% mutate(site="West End") %>%
  bind_rows(mac_on_pter_dutch)

ggplot(mac_on_pter,aes(x=mac,fill=site,y=..count..)) +
  geom_histogram(binwidth=0.05,position="identity",alpha=0.5,color="gray70")+
  geom_vline(xintercept = 0,linetype=2)+
  labs(title="",x="Interaction Strength",y="")+
  scale_fill_manual(values=c("darkgreen","mediumpurple4"),name="Monitoring Site")+
  theme_minimal()+
  theme(legend.position=c(0.7,0.5),axis.text.y=element_blank())
```

## Pterygophora and Macrocystis competition, West End

```{r west end competition}
westend_pter_mac <- westend.multi.mods$mac$coeffs %>% 
  select(period,pter) %>% 
  rename(pter_on_mac=pter) %>%
  bind_cols(select(westend,npgo.mean))

westend_mac_pter <- westend.multi.mods$pter$coeffs %>% 
  select(period,mac) %>% 
  rename(mac_on_pter=mac) %>%
  bind_cols(select(westend,npgo.mean))

ggplot(westend_pter_mac, aes(x=npgo.mean,y=pter_on_mac))+
  geom_point(col="darkred") +
  geom_hline(yintercept = 0,linetype=1)+
  geom_smooth(method="lm",linetype=2,col="darkred",se=F)+
  labs(x="NPGO Index (normalized)",y="Interaction Strength")+
  theme_minimal()

ggplot(westend_mac_pter, aes(x=npgo.mean,y=mac_on_pter))+
  geom_point(col="darkred") +
  geom_hline(yintercept = 0,linetype=1)+
  geom_smooth(method="lm",linetype=2,col="darkred",se=F)+
  labs(x="NPGO Index (normalized)",y="Interaction Strength")+
...
# Using quantreg
quant_reg_plot(westend$npgo.mean,westend.multi.mods$mac$coeffs$pter,
               xlab="NPGO Index (normalized)",ylab=expression(paste(delta,"mac/",delta,"pter")),
               lvl=0.9,xlim=c(-2,1.5)) ##*##
quant_reg_plot(westend$npgo.mean,westend.multi.mods$pter$coeffs$mac,
               xlab="NPGO Index (normalized)",ylab=expression(paste(delta,"mac/",delta,"pter")),
               lvl=0.9,xlim=c(-2,1.5)) ##*##
```